...
[Полный состав для согласования](context-gateway-scope-review.md) — датированный
снимок 12 эпиков и 106 срезов с критериями, зависимостями и индексом проверок.
Актуальное состояние каждой задачи проверяется в Beads.
