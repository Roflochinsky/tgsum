...
Реализован профиль Linux x86_64 offline; конкретные Codex/Claude adapters и облачный доступ остаются в `hzm.7`/`hzm.8`, квалификация с пользователем — в `t8t.19`.
